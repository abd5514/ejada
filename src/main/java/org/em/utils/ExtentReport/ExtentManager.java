...
public class ExtentManager {
    ...
    private static final String reportFileName = "SMBU-WEB-Automation Report";
    private static final String macPath = System.getProperty("user.dir") +"/target/"+ "/TestReport";
    private static final String windowsPath = System.getProperty("user.dir") + "/target/"+"\\TestReport";
    ...
    private static final String linuxPath = System.getProperty("user.dir") +"/target/"+ "/TestReport";
    ...
    public static ExtentReports createInstance() {
        ...
        htmlReporter.config().setReportName("SMBU-WEB-Automation Report");
